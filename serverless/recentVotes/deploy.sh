...
FUNCTION_NAME="recentVotes"
ZIP_FILE="function.zip"
ROLE_ARN="arn:aws:iam::152769399840:role/service-role/recentVotes-role-ua5kpray"

# Check if required files exist
if [ ! -f "recentVotes.js" ]; then
    echo "Error: recentVotes.js not found in current directory ($(pwd))"
    exit 1
fi

# Create deployment package
rm -f $ZIP_FILE  # Remove any existing zip file
zip -r $ZIP_FILE recentVotes.js
