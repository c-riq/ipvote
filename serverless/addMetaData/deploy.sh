...
ROLE_ARN="arn:aws:iam::152769399840:role/service-role/addMetaData-role-n9ict6ac"

# Check if required files exist
if [ ! -f "addMetaData.js" ]; then
    echo "Error: addMetaData.js not found in current directory ($(pwd))"
    exit 1
fi

# Create deployment package
rm -f $ZIP_FILE  # Remove any existing zip file
zip -r $ZIP_FILE addMetaData.js
