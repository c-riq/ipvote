...
if [ -z "$TWILIO_PHONE_NUMBER" ]; then
    echo "Error: TWILIO_PHONE_NUMBER environment variable is not set in .env"
    exit 1
fi
...
ENV_VARS="Variables={TWILIO_ACCOUNT_SID=$TWILIO_ACCOUNT_SID,TWILIO_AUTH_TOKEN=$TWILIO_AUTH_TOKEN,TWILIO_PHONE_NUMBER=$TWILIO_PHONE_NUMBER}"
